...
OUTPUT_ARCH(arm)
ENTRY(_start)
SEARCH_DIR("=/Volumes/cg-nt/x-tools/aarch64-unknown-linux-gnueabi/aarch64-unknown-linux-gnueabi/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{

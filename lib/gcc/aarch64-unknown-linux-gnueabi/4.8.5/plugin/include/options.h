...
enum opt_code
{
  ...
  OPT_mandroid = 1038,                       /* -mandroid */
  OPT_march_ = 1039,                         /* -march= */
  OPT_mbig_endian = 1040,                    /* -mbig-endian */
  OPT_mbionic = 1041,                        /* -mbionic */
  OPT_mcmodel_ = 1042,                       /* -mcmodel= */
  OPT_mcpu_ = 1043,                          /* -mcpu= */
  OPT_mfix_cortex_a53_835769 = 1044,         /* -mfix-cortex-a53-835769 */
  OPT_mgeneral_regs_only = 1045,             /* -mgeneral-regs-only */
  OPT_mglibc = 1046,                         /* -mglibc */
  OPT_mlittle_endian = 1047,                 /* -mlittle-endian */
  OPT_mmusl = 1048,                          /* -mmusl */
  OPT_momit_leaf_frame_pointer = 1049,       /* -momit-leaf-frame-pointer */
  OPT_mstrict_align = 1050,                  /* -mstrict-align */
  OPT_mtls_dialect_ = 1051,                  /* -mtls-dialect= */
  OPT_mtune_ = 1052,                         /* -mtune= */
  OPT_muclibc = 1053,                        /* -muclibc */
  OPT_n = 1054,                              /* -n */
  OPT_no_canonical_prefixes = 1055,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1056,              /* -no-integrated-cpp */
  OPT_nocpp = 1057,                          /* -nocpp */
  OPT_nodefaultlibs = 1058,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1059,                   /* -nostartfiles */
  OPT_nostdinc = 1060,                       /* -nostdinc */
  OPT_nostdinc__ = 1061,                     /* -nostdinc++ */
  OPT_nostdlib = 1062,                       /* -nostdlib */
  OPT_o = 1063,                              /* -o */
  OPT_p = 1064,                              /* -p */
  OPT_pass_exit_codes = 1065,                /* -pass-exit-codes */
  /* OPT_pedantic = 1066, */                 /* -pedantic */
  OPT_pedantic_errors = 1067,                /* -pedantic-errors */
  OPT_pg = 1068,                             /* -pg */
  OPT_pie = 1069,                            /* -pie */
  OPT_pipe = 1070,                           /* -pipe */
  OPT_posix = 1071,                          /* -posix */
  OPT_print_file_name_ = 1072,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1073,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1074,          /* -print-multi-directory */
  OPT_print_multi_lib = 1075,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1076,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1077,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1078,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1079,               /* -print-prog-name= */
  OPT_print_search_dirs = 1080,              /* -print-search-dirs */
  OPT_print_sysroot = 1081,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1082,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1083,                        /* -profile */
  OPT_pthread = 1084,                        /* -pthread */
  OPT_quiet = 1085,                          /* -quiet */
  OPT_r = 1086,                              /* -r */
  OPT_rdynamic = 1087,                       /* -rdynamic */
  OPT_remap = 1088,                          /* -remap */
  OPT_s = 1089,                              /* -s */
  OPT_s_bc_abi = 1090,                       /* -s-bc-abi */
  OPT_save_temps = 1091,                     /* -save-temps */
  OPT_save_temps_ = 1092,                    /* -save-temps= */
  OPT_shared = 1093,                         /* -shared */
  OPT_shared_libgcc = 1094,                  /* -shared-libgcc */
  /* OPT_specs = 1095, */                    /* -specs */
  OPT_specs_ = 1096,                         /* -specs= */
  OPT_static = 1097,                         /* -static */
  OPT_static_libasan = 1098,                 /* -static-libasan */
  OPT_static_libgcc = 1099,                  /* -static-libgcc */
  OPT_static_libgcj = 1100,                  /* -static-libgcj */
  OPT_static_libgfortran = 1101,             /* -static-libgfortran */
  OPT_static_libgo = 1102,                   /* -static-libgo */
  OPT_static_libstdc__ = 1103,               /* -static-libstdc++ */
  OPT_static_libtsan = 1104,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1105, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1106, */                /* -std=c++0x */
  OPT_std_c__11 = 1107,                      /* -std=c++11 */
  OPT_std_c__1y = 1108,                      /* -std=c++1y */
  OPT_std_c__98 = 1109,                      /* -std=c++98 */
  OPT_std_c11 = 1110,                        /* -std=c11 */
  /* OPT_std_c1x = 1111, */                  /* -std=c1x */
  /* OPT_std_c89 = 1112, */                  /* -std=c89 */
  OPT_std_c90 = 1113,                        /* -std=c90 */
  OPT_std_c99 = 1114,                        /* -std=c99 */
  /* OPT_std_c9x = 1115, */                  /* -std=c9x */
  OPT_std_f2003 = 1116,                      /* -std=f2003 */
  OPT_std_f2008 = 1117,                      /* -std=f2008 */
  OPT_std_f2008ts = 1118,                    /* -std=f2008ts */
  OPT_std_f95 = 1119,                        /* -std=f95 */
  OPT_std_gnu = 1120,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1121, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1122, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1123,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1124,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1125,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1126,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1127, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1128, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1129,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1130,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1131, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1132, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1133,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1134, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1135, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1136, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1137,                     /* -std=legacy */
  OPT_symbolic = 1138,                       /* -symbolic */
  OPT_t = 1139,                              /* -t */
  OPT_time = 1140,                           /* -time */
  OPT_time_ = 1141,                          /* -time= */
  OPT_tno_android_cc = 1142,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1143,                 /* -tno-android-ld */
  OPT_traditional = 1144,                    /* -traditional */
  OPT_traditional_cpp = 1145,                /* -traditional-cpp */
  OPT_trigraphs = 1146,                      /* -trigraphs */
  OPT_u = 1147,                              /* -u */
  OPT_undef = 1148,                          /* -undef */
  OPT_v = 1149,                              /* -v */
  OPT_version = 1150,                        /* -version */
  OPT_w = 1151,                              /* -w */
  OPT_wrapper = 1152,                        /* -wrapper */
  OPT_x = 1153,                              /* -x */
  OPT_z = 1154,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,

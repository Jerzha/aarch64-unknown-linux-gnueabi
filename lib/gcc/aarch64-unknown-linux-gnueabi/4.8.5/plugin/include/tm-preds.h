/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/Volumes/aarch64/.build/src/gcc-4.8.5/gcc/config/aarch64/aarch64.md'.  */
...
extern int aarch64_const_address (rtx, enum machine_mode);
